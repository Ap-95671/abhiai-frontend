import { AssistantWorkspace } from "@/components/ai-character/assistant-workspace";
...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col"><AssistantWorkspace>{children}</AssistantWorkspace></body>
    </html>
  );
}
