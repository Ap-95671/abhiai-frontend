...
import type { AssistantCharacterState, AssistantExpression, AnimationMode } from "./assistant-state";
  ...
  return <div className={`${styles.avatar} ${small ? styles.smallAvatar : ""}`} data-state={state} data-expression={expression} data-animations={animations} aria-hidden="true"
    ...
    <svg viewBox="0 0 180 160" focusable="false">
      ...
      <g className={styles.characterBody}>
        ...
        <g className={styles.gaze}><path className={styles.brows} d="M66 58 Q72 55 78 58 M102 58 Q108 55 114 58"/><g className={styles.eyes}><ellipse cx="72" cy="70" rx="5" ry="7" /><ellipse cx="108" cy="70" rx="5" ry="7" /></g></g>
